...
export const products: Product[] = [
    ...
    },
    {
        ...
        name: 'Fresh Fruits',
        price: 15.99,
        image: 'https://images.unsplash.com/photo-1619566636858-adf3ef46400b?auto=format&fit=crop&q=80&w=200',
    },
    {
        id: 5,
        name: 'Organic Tea',
                    ...
                    <div key={product.name} className="group">
                        <div className="bg-gray-100 rounded-lg p-4 mb-4 relative">
                            ...
                            <button
                                ...
                                className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-green-600 text-white px-6 py-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                                Add to Cart
                            </button>
                        </div>
